...
public class MeetingFutureSelectorQueryBuilderDecorator implements IQueryBuilder {
    ...
    public MeetingFutureSelectorQueryBuilderDecorator(IQueryBuilder wrapped) {
        this(wrapped, "meetings.");
    }

    public MeetingFutureSelectorQueryBuilderDecorator(IQueryBuilder wrapped, String meetingsTablePrefix) {
